...
import numpy as np
import pandas as pd
from class_read_trans_rtcis import *


def get_df():
    try:
        path_open_csv = "file_source/data_trans_tonghop.csv"
        path_open_loc_user = "file_source/loc_user.xlsx"
...
manpower = selection_query.groupby(['date_shift', 'group'])['user'].agg('count').reset_index()
